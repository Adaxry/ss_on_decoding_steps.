...
def decoding_graph(features, state, mode, params):
    ...
    if params.trainstep_scheduled_sampling_strategy == "linear":
        ...
        current_step_threshold = params.trainstep_sigmoid_k / (params.trainstep_sigmoid_k + tf.exp(step/params.trainstep_sigmoid_k)) 
...
class Transformer(NMTModel):
    ...
    def get_parameters():
        params = tf.contrib.training.HParams(
            ...
            trainstep_scheduled_sampling_strategy="",
            timestep_scheduled_sampling_strategy="",
            mle_rate=1.0,
            trainstep_exp_radix=0.99995, # for 20w step
            trainstep_sigmoid_k=10000, # for 20w step
