...
import thumt.utils.radam as radam
    ...
    with tf.Graph().as_default():
        ...
        with tf.train.MonitoredTrainingSession(
            ...
            while not sess.should_stop():
                sess.run(train_op)
                step_count+=1
                if (step_count+1) % params.save_checkpoint_steps == 0:
                    sess.run_step_fn(save_fn)
